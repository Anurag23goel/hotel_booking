...
export default function PropertyPhotosForm({
  setCurrentForm,
  updateFormData,
  formData,
}: PropertyPhotosFormProps) {
  ...
  return (
    <div className="flex-1 max-w-4xl mx-auto w-full px-4 py-8 md:py-12">
      ...
      <div className="bg-white rounded-md border border-gray-200 p-6 mb-6">
        <p className="mb-4">
          <strong>Upload at least 5 photos of your property.</strong> The more
          you upload, the more likely you are to get bookings. You can add more
          later.
        </p>
        ...
        {photos.length > 0 && photos.length < 5 && (
          <div className="mt-4 flex items-center text-amber-600">
            ...
            <span>
              Upload at least {5 - photos.length} more photos to continue
            </span>
          </div>
        )}
      </div>
      ...
      <div className="flex gap-4">
        ...
        <button
          className={`flex-1 md:flex-none md:min-w-[200px] h-12 rounded-md text-white ${
            photos.length >= 5
              ? "bg-[#0071c2] hover:bg-[#00487a]"
              : "bg-[#0071c2] opacity-50 cursor-not-allowed"
          }`}
