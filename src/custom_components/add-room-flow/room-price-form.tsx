...
export default function RoomPriceForm({
  ...
  const commission = priceDetails.price
    ? Number.parseFloat(priceDetails.price) * 0.69
    : 0;
  const earnings = priceDetails.price
    ? Number.parseFloat(priceDetails.price) - commission
    : 0;
        ...
        <>
          ...
          <div className="bg-white rounded-md border border-gray-200 p-6 mb-6">
            <p className="text-gray-600 mb-6">
              ...
              based on data from properties like yours, but they can be edited
            ...
            <div className="mb-8">
              ...
              <div className="mb-4 flex justify-between items-center">
                ...
                <button className="text-[#0071c2] text-sm font-medium">
                  Edit
                </button>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="flex justify-between py-2 border-b">
                  ...
                  <div>
                    <span>
                      {priceDetails.currency}{" "}
                      {Number.parseFloat(priceDetails.price).toFixed(2)}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex justify-between py-2">
                  ...
                  <div>
                    <span>
                      {priceDetails.currency}{" "}
                      {(Number.parseFloat(priceDetails.price) * 0.9).toFixed(2)}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <p className="text-xs text-gray-500 mb-4">
                This policy is set at the property level – any changes made will
                be applied to all rooms.
              </p>
              ...
              <div className="space-y-3">
                <div className="flex items-start">
                  ...
                  <p className="text-sm">
                    Guests can cancel their bookings for free before 18:00 on
                    the day of arrival. The guests will be charged cost of the
                    first night if they cancel after this.
                  </p>
                </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-sm">
                    Guests can cancel their bookings for free before 18:00 on
                    the day of arrival. The guests will be charged cost of the
                    first night if they cancel after this (based on the standard
