...
const Page = () => {
  ...
  return (
    <div className="min-h-screen sm:px-3 bg-gray-50">
      <div className=" border-black border-4 bg-[#057d23] md:min-h-[45vh] min-h-[25vh] w-full">
      ...
      <div className=" border-black border-2 bg-white shadow-sm py-4">
        <div className="max-w-5xl  mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          <div className="flex gap-2">
            <button
            className='rounded-sm p-2  border-black border-2 hover:bg-gray-950 hover:text-white'
            >
              List
            </button>
            <button
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
        <div className=" border-black border-2  grid grid-cols-2 gap-6">
