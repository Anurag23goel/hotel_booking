    ...
    <div className="flex-1 max-w-4xl mx-auto w-full px-4 py-8 md:py-12">
          ...
          {showInfoBox && (
            <div className="relative mb-4 bg-gray-50 border border-gray-200 p-4 rounded-md">
              ...
              <p className="text-sm text-gray-600 mt-2">
                Right now, you just need to add your basic sleeping
                arrangements. Cots, additional beds and other sleeping
                arrangements can be added in the extranet, the platform
              ...
              <div className="flex items-center">
                <button
                  onClick={() =>
                    handleBedChange(
                      "singleBed",
                      Math.max(0, roomDetails.beds.singleBed - 1)
                    )
                  }
                ...
                <span className="w-8 text-center">
                  {roomDetails.beds.singleBed}
                </span>
                <button
                  onClick={() =>
                    handleBedChange("singleBed", roomDetails.beds.singleBed + 1)
                  }
                  className="w-8 h-8 flex items-center justify-center border border-gray-300 rounded-md"
                >
                  +
              ...
              <div className="flex items-center">
                <button
                  onClick={() =>
                    handleBedChange(
                      "doubleBed",
                      Math.max(0, roomDetails.beds.doubleBed - 1)
                    )
                  }
                  className="w-8 h-8 flex items-center justify-center border border-gray-300 rounded-md"
                ...
                <span className="w-8 text-center">
                  {roomDetails.beds.doubleBed}
                </span>
                <button
                  onClick={() =>
                    handleBedChange("doubleBed", roomDetails.beds.doubleBed + 1)
                  }
                  className="w-8 h-8 flex items-center justify-center border border-gray-300 rounded-md"
                >
                  +
              ...
              <div className="flex items-center">
                <button
                  onClick={() =>
                    handleBedChange(
                      "largeBed",
                      Math.max(0, roomDetails.beds.largeBed - 1)
                    )
                  }
                  className="w-8 h-8 flex items-center justify-center border border-gray-300 rounded-md"
                ...
                <span className="w-8 text-center">
                  {roomDetails.beds.largeBed}
                </span>
                <button
                  onClick={() =>
                    handleBedChange("largeBed", roomDetails.beds.largeBed + 1)
                  }
                  className="w-8 h-8 flex items-center justify-center border border-gray-300 rounded-md"
                >
                  +
              ...
              <div className="flex items-center">
                <button
                  onClick={() =>
                    handleBedChange(
                      "extraLargeBed",
                      Math.max(0, roomDetails.beds.extraLargeBed - 1)
                    )
                  }
                  className="w-8 h-8 flex items-center justify-center border border-gray-300 rounded-md"
                ...
                <span className="w-8 text-center">
                  {roomDetails.beds.extraLargeBed}
                </span>
                <button
                  onClick={() =>
                    handleBedChange(
                      "extraLargeBed",
                      roomDetails.beds.extraLargeBed + 1
                    )
                  }
                  className="w-8 h-8 flex items-center justify-center border border-gray-300 rounded-md"
                >
          ...
          <div className="flex items-center">
            <button
              onClick={() =>
                handleInputChange(
                  "guestCount",
                  Math.max(1, roomDetails.guestCount - 1)
                )
              }
              className="w-8 h-8 flex items-center justify-center border border-gray-300 rounded-md"
            ...
            <button
              onClick={() =>
                handleInputChange("guestCount", roomDetails.guestCount + 1)
              }
              className="w-8 h-8 flex items-center justify-center border border-gray-300 rounded-md"
            >
              +
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <select
                ...
                onChange={(e) =>
                  handleInputChange("roomSizeUnit", e.target.value)
                }
      ...
      <div className="flex gap-4">
        <button
          ...
          onClick={() => {
            // Don't save room data when going back
