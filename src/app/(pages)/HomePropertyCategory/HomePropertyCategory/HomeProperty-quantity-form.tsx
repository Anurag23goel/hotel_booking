...
interface PropertyQuantityFormProps {
  ...
  updateFormData: (data: { quantity: string; locationType?: string }) => void;
  formData: {
    propertyType: string;
    quantity: string;
    locationType?: string;
...
export default function PropertyQuantityForm({
  setCurrentForm,
  updateFormData,
  formData,
}: PropertyQuantityFormProps) {
  const [selectedOption, setSelectedOption] = useState<string>(
    formData.quantity || "single"
  );
  const [locationType, setLocationType] = useState<string>(
    formData.locationType || "same"
  );
  ...
  const handleContinue = () => {
    if (selectedOption) {
      updateFormData({
        ...
        ...(selectedOption === "multiple" && { locationType }),
      });
    ...
    >
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-gray-600">
                    One {propertyType} with one or multiple rooms that guests
                    can book
                  </p>
                </div>
                {selectedOption === "single" && (
            ...
            <div className="flex-1">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-gray-600">
                    Multiple {propertyType}s with one or multiple rooms that
                    guests can book
                  </p>
                </div>
                {selectedOption === "multiple" && (
        ...
        {selectedOption === "multiple" && (
          ...
          >
            <h3 className="font-semibold text-lg mb-4">
              Are all properties in the same location?
            </h3>
            <div className="space-y-3">
              <motion.div
                ...
                onClick={() => setLocationType("same")}
              >
                <div className="flex gap-6">
                  <div className="flex-shrink-0">
                    <div className="p-3 bg-blue-100 rounded-lg">
                      <Image
                        src="/assets/sameLocation.png"
                        alt="Same location"
                        width={40}
                        height={40}
                        className="text-[#0071c2]"
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p className="text-gray-600">
                          All properties are located in the same building or
                          complex
                        </p>
                      </div>
                      {locationType === "same" && (
              ...
              >
                <div className="flex gap-6">
                  <div className="flex-shrink-0">
                    <div className="p-3 bg-blue-100 rounded-lg">
                      <Image
                        src="/assets/differentLocation.png"
                        alt="Different locations"
                        width={40}
                        height={40}
                        className="text-[#0071c2]"
                      />
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p className="text-gray-600">
                          Properties are located in different buildings or areas
                        </p>
                      </div>
                      {locationType === "different" && (
                        <motion.div
      ...
      >
        ...
        <button
          ...
          disabled={
            !selectedOption || (selectedOption === "multiple" && !locationType)
          }
